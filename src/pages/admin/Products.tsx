...
import { Package, Search, Edit, Trash2, ShoppingCart, BarChart3 } from 'lucide-react';
    ...
    <AdminLayout>
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-600 mt-1">Administra el inventario del supermercado</p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-semibold text-slate-900 mt-2">{products.length}</p>
                </div>
        ...
        <Card className="border-slate-100 shadow-sm">
          <CardHeader className="border-b border-slate-100">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg font-semibold text-slate-900">Inventario de Productos</CardTitle>
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    filteredProducts.map((product) => (
                      <TableRow key={product.id_producto} className="hover:bg-slate-50">
                        <TableCell className="font-mono text-sm text-slate-600">{product.codigo_unico}</TableCell>
                        ...
                        <TableCell className="text-slate-600">{product.unidad_tipo}</TableCell>
                        <TableCell className="font-medium text-slate-900">{product.unidad_cantidad}</TableCell>
                        <TableCell>
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="text-center py-12">
                        ...
                        <p className="text-sm text-slate-500">Agrega uno nuevo para comenzar</p>
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
