...
import { ArrowLeft, User, Mail, Shield, Activity, Home, UserCircle2, Briefcase, CheckCircle, Clock } from 'lucide-react';
...
const ReponedorProfile = () => {
  ...
  const userName = profileData.nombre || 'Reponedor';
            ...
            <Card className="border-slate-200 bg-gradient-to-br from-blue-50 to-indigo-50">
              <CardContent className="p-6">
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 flex items-center justify-center text-white text-4xl font-bold shadow-xl">
            ...
            <Card className="border-blue-200 bg-blue-50/50">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-blue-900 mb-1">Información de Solo Lectura</h3>
                    <p className="text-sm text-blue-700">
                      Los datos de tu perfil son gestionados por el supervisor. Si necesitas realizar cambios en tu información personal, contacta a tu supervisor.
                    </p>
                  </div>
                </div>
              </CardContent>
